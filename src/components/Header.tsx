...
export const Header = ({ className }: { className?: string }) => {
    return (
        <div className={cn('fixed z-[999] top-12 left-0 right-0 px-8 md:px-14 lg:px-20', className)}>
            <div className="max-w-7xl mx-auto flex justify-between rounded-3xl backdrop-blur-md bg-[rgba(255,255,255,0.5)] pl-4 py-1">
                <Link to="/" className='w-16 h-auto rounded-2xl'>
