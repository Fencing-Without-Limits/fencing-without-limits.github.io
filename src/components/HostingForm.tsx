...
export const HostingForm: FC = () => {
    const submitHandler: React.FormEventHandler<HTMLFormElement> = (event) => {
        ...
        window.location.href = `mailto:fencingwithoutlimits@gmail.com
    ...
    return (
        <form
            ...
            grid grid-cols-4 max-md:grid-cols-2 gap-4'
        >
            ...
            <button type="submit" className="text-white text-xl bg-blue-600 rounded-md py-1.5 px-3" >
                Send
            </button>
        </form>
    )
