...
export const Home: FC = () => {
  return (
    <div className="">
      <section id="hero" className="relative overflow-clip h-[95dvh] min-h-fit">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-10 *:mb-6 px-8 md:px-14 lg:px-20 *:max-w-7xl *:mx-auto mb-8">
          <HeaderSpace />
          <h1 className='text-h1 text-white'>
            We are fencers on a mission to make sports accessible for <b>everyone.</b>
          </h1>
          <h2 className='md:text-3xl text-2xl text-gray-300'>
